    ...
    (org-with-point-at pom
      ...
      (unless (org-before-first-heading-p)
        (let* ((id (org-entry-get nil "ID"))
          ...
          ;; return plist
          (list :link (concat "id:" id-str) :description head-str)))))
  ...
  subtree."
    ...
    (org-with-point-at pom
      (let* ((from-link (mel/org-set-node-id))
             ...
             (to-id (org-element-property :path to-context))
             (ref-heading "ref")
             (found-ref-p nil)
             ;;to-level
             (to-heading ""))
