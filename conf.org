...
* [2021-06-27 Sun 22:32] 设置 org mode
  ...
  #+begin_src emacs-lisp :noweb-ref org-config
    ...
    (defun mel/expand-org-inbox-file (file-name)
    ...
    (defvar mel/org-agenda-files
      (delete-dups
       (list
        ...
        ;; previous one.
        (file-name-as-directory (mel/expand-org-inbox-file "."))))
  ...
  #+begin_src emacs-lisp :noweb-ref org-config
    ...
    (setq org-directory mel/org-file-dir
          ...
          mel/org-note-file (mel/expand-org-inbox-file "note.org")
  ...
  #+begin_src emacs-lisp :noweb-ref org-config
    ;; capture inbox
    (let ((mel/org-inbox-file (mel/expand-org-inbox-file "inbox.org")))
  ...
  #+begin_src emacs-lisp :noweb-ref org-config
    ;; capture material
    (let ((mel/org-material-file (mel/expand-org-inbox-file "material.org")))
  ...
  #+begin_src emacs-lisp :noweb-ref org-config
    ;; capture journal
    (let ((mel/org-journal-file (mel/expand-org-inbox-file "journal.org")))
  ...
  #+begin_src emacs-lisp :noweb-ref org-config
    ;; capture project
    (let ((mel/org-prj-file (mel/expand-org-inbox-file "project.org")))
  ...
  #+begin_src emacs-lisp :noweb-ref org-config
    ...
    (let ((mel/org-review-file (mel/expand-org-inbox-file "review.org")))
